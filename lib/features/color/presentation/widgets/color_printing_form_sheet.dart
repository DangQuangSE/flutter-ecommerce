...
class ColorPrintingFormSheet extends StatefulWidget {
  final PrintingColorEntity? color;
  final ValueChanged<PrintingColorEntity> onSubmit;

  const ColorPrintingFormSheet({
    super.key,
    this.color,
...
class _ColorPrintingFormSheetState extends State<ColorPrintingFormSheet> {
  ...
  void _submit() {
    ...
    widget.onSubmit(PrintingColorEntity(
      id: widget.color?.id,
      name: name,
      hexCode: hex,
      isActive: _activeVal,
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  _isEdit
                      ? AppStrings.adminColorPrintingFormEditTitle
                      : AppStrings.adminColorPrintingFormCreateTitle,
                  style: GoogleFonts.lexend(
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                hintText: AppStrings.adminColorPrintingNameHint,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: AppStrings.adminColorPrintingHexHint,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const _FormLabel(AppStrings.adminColorStatusLabel),
                Switch.adaptive(
                  value: _activeVal,
                  activeThumbColor: AppColors.primary,
                  onChanged: (val) => setState(() => _activeVal = val),
                ),
              ],
            ),
            AppSizes.spacingLg,

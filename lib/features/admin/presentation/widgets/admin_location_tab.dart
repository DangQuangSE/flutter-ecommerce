          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text(
                  'Vị trí của cửa hàng',
                  style: GoogleFonts.lexend(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.textPrimary),
                ),
              ],
            ),
          ),
                              ...
                              child: Transform.scale(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Icon(Icons.location_on_rounded, size: 48, color: AppColors.primary),
                                  ],
                                ),
                              ),
                            );
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text('SHOWROOM', style: GoogleFonts.inter(fontSize: 8, fontWeight: FontWeight.w800, color: AppColors.primary)),
                        ),
                        const SizedBox(height: 8),
                        Text('Sport Pro Showroom', style: GoogleFonts.lexend(fontSize: 18, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
                        const SizedBox(height: 14),
                        _infoRow(Icons.location_on_rounded, '123 Nguyễn Văn Linh, Quận 7, TP. Hồ Chí Minh'),
                        const SizedBox(height: 10),
                        _infoRow(Icons.phone_rounded, '0909 123 456'),
                        const SizedBox(height: 10),
                        _infoRow(Icons.access_time_filled_rounded, '08:00 - 21:00'),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _infoRow(IconData icon, String text) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(text, style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
        ),
      ],
    );
  }

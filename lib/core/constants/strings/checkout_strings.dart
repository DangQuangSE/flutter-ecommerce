...
abstract final class CheckoutStrings {
  ...
  static const String shippingInfoRequired = 'Vui lòng điền đầy đủ thông tin giao hàng!';
  ...
  static const String phoneInvalid = 'Số điện thoại không hợp lệ (VD: 0912345678)';
  static const String shippingAddressLabel = 'ĐỊA CHỈ GIAO HÀNG';
  static const String shippingAddressRequired = 'Vui lòng nhập địa chỉ giao hàng';
  static const String shippingEditHint = 'Bạn có thể chỉnh sửa thông tin giao hàng bên dưới nếu cần.';
  ...
  static const String couponInvalid = 'Mã giảm giá không hợp lệ hoặc đã hết hạn';
  static const String couponMinOrderNotMet = 'Đơn hàng chưa đạt giá trị tối thiểu';
  ...
  static const String noAddressMessage = 'Thêm địa chỉ giao hàng để tiến hành đặt hàng.';
  ...
  static const String couponLoadError = 'Không tải được mã giảm giá. Nhấn để thử lại.';

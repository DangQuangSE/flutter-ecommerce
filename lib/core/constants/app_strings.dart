...
abstract final class AppStrings {
  ...
  static const String forgotPasswordResetSuccess = 'Đặt lại mật khẩu thành công. Vui lòng đăng nhập.';
  ...
  static const String forgotPasswordOtpHelp = 'Nếu bạn không nhận được mã, kiểm tra email hoặc quay lại.';
  ...
  static const String checkoutAddressRequired = 'Vui lòng chọn địa chỉ giao hàng!';
  static const String checkoutShippingInfoRequired = 'Vui lòng điền đầy đủ thông tin giao hàng!';
  ...
  static const String checkoutPhoneInvalid = 'Số điện thoại không hợp lệ (VD: 0912345678)';
  static const String checkoutShippingAddressLabel = 'ĐỊA CHỈ GIAO HÀNG';
  static const String checkoutShippingAddressRequired = 'Vui lòng nhập địa chỉ giao hàng';
  static const String checkoutShippingEditHint = 'Bạn có thể chỉnh sửa thông tin giao hàng bên dưới nếu cần.';
  static const String checkoutEmptyTitle = 'ĐƠN HÀNG RỖNG';
  static const String checkoutEmptyMessage = 'Không tìm thấy sản phẩm nào để thanh toán. Hãy quay về giỏ hàng hoặc tiếp tục mua sắm nhé!';
  static const String checkoutBackToShopping = 'QUAY LẠI MUA SẮM';
  static const String checkoutLoadErrorTitle = 'Không thể tải thông tin thanh toán.';
  ...
  static const String checkoutCouponInvalid = 'Mã giảm giá không hợp lệ hoặc đã hết hạn';
  static const String checkoutCouponMinOrderNotMet = 'Đơn hàng chưa đạt giá trị tối thiểu';
  ...
  static const String checkoutNoAddressMessage = 'Thêm địa chỉ giao hàng để tiến hành đặt hàng.';
  ...
  static const String checkoutCouponLoadError = 'Không tải được mã giảm giá. Nhấn để thử lại.';
  static const String checkoutCouponLoading = 'Đang tải mã giảm giá...';
  static const String checkoutCouponChooseOrEnter = 'Chọn hoặc nhập mã giảm giá';
  static const String paymentVnpayTitle = 'VNPay';
  static const String paymentCancelTitle = 'Hủy thanh toán?';
  static const String paymentCancelMessage = 'Bạn có chắc muốn hủy thanh toán VNPay? Đơn hàng vẫn ở trạng thái chờ thanh toán.';
  ...
  static const String cartEmptyMessage = 'Bạn chưa thêm bất kỳ sản phẩm nào vào giỏ hàng. Hãy khám phá bộ sưu tập thể thao Pro ngay!';
  ...
  static String cartSelectAll(int selected, int total) => 'CHỌN TẤT CẢ ($selected/$total)';
  static const String cartRemoveItemTitle = 'Xóa sản phẩm?';
  static String cartRemoveItemMessage(String name) => 'Bạn có chắc chắn muốn xóa $name khỏi giỏ hàng?';
  static const String cartRemoveItemConfirm = 'XÓA BỎ';
  static const String cartRemoveDesignTitle = 'Xóa thiết kế in ấn?';
  static String cartRemoveDesignMessage(String name) => 'Bạn có chắc muốn xóa thiết kế in ấn khỏi sản phẩm $name? Thiết kế của bạn sẽ bị hủy và sản phẩm được trả về dạng nguyên bản.';
  ...
  static String customDesignSpecPricingFormula(String textUnitPrice, String imageUnitPrice) => 'Công thức: (Số lớp chữ x $textUnitPrice/lớp) + (Số logo x $imageUnitPrice/ảnh)';
  static const String notificationTitle = 'Thông báo';
  static const String notificationEmptyTitle = 'KHÔNG CÓ THÔNG BÁO';
  static const String notificationEmptyMessage = 'Hộp thư của bạn hiện đang trống. Mọi cập nhật về đơn hàng hoặc ưu đãi đặc biệt sẽ xuất hiện tại đây!';
  ...
  static const String notificationMarkAllReadSuccess = 'Đã đánh dấu đọc tất cả thông báo.';
  static const String notificationNoUnread = 'Không có thông báo chưa đọc mới nào.';
  static const String notificationLoadErrorTitle = 'Đã xảy ra lỗi khi tải danh sách thông báo.';
  ...
  static const String notificationSoundSubtitle = 'Phát âm thanh khi có thông báo mới';
  ...
  static const String chatEmptyMessage = 'Cuộc trò chuyện với cửa hàng sẽ xuất hiện tại đây khi khởi tạo thành công.';
  ...
  static const String chatEscalationMessage = 'Yêu cầu hỗ trợ đã được chuyển tiếp đến giám sát viên.';
  ...
  static const String productFilterCategoryLoadError = 'Không tải được danh mục';
  static const String productFilterBrandLoadError = 'Không tải được thương hiệu';
  ...
  static const String productHomeFeaturedEmpty = 'Không có sản phẩm nổi bật nào.';
  ...
  static const String productHomeHeroSubtitle = 'Trang bị đỉnh cao cho những vận động viên không ngừng vươn lên và chinh phục đỉnh cao mới.';
  ...
  static const String productListEmptySubtitle = 'Không có sản phẩm nào phù hợp với bộ lọc đã chọn.';
  ...
  static String productFilterPriceBetween(String min, String max) => '$min - $max';
  ...
  static const String reviewsLoadError = 'Không thể tải đánh giá. Vui lòng thử lại sau.';
  ...
  static String reviewImageCounter(int current, int total) => '$current / $total';
  ...
  static const String returnPolicyLoadError = 'Không thể tải nội dung chính sách. Vui lòng thử lại sau.';
  ...
  static const String productDetailLoadError = 'Đã xảy ra lỗi khi tải chi tiết sản phẩm.';
  static String addedToCartMessage(String productName, String size) => 'Đã thêm $productName (Size $size) vào giỏ hàng!';
  ...
  static const String customizerUploadImageError = 'Không thể tải ảnh. Vui lòng kiểm tra quyền truy cập thư viện.';
  static const String customizerUploadLogoServerError = 'Không thể tải logo lên. Vui lòng thử lại.';
  ...
  static const String customizerSaveSuccess = 'Đã lưu thiết kế lên hệ thống thành công!';
  ...
  static const String customizerPanelSubtitle = 'Tự tay thiết kế áo thi đấu đẳng cấp cao. Tên, số áo và logo tùy chỉnh theo ý bạn.';
  ...
  static const String customizerNoTextLayerSelected = 'Chọn hoặc thêm một lớp chữ để bắt đầu chỉnh sửa.';
  ...
  static String customizerSportFontLabel(String font) => '$font (Thể thao)';
  static String customizerPrintingPrice(String price) => 'Giá in thêm: $price ₫';
  ...
  static const String orderEmptySubtitle = 'Các giao dịch thuộc danh mục này sẽ xuất hiện tại đây.';
  static const String orderListLoadError = 'Không thể tải đơn hàng. Vui lòng thử lại sau.';
  static const String orderQuantityLabel = 'Số lượng';
  static const String orderDetailLoadError = 'Không thể tải chi tiết đơn hàng. Vui lòng thử lại sau.';
  ...
  static String orderCustomPrinting(int designId, String price) => 'In tùy chỉnh #$designId · +$price';
  ...
  static const String designViewerLimited = 'Metadata không đầy đủ; ảnh preview vẫn là bản thiết kế chính xác.';
  ...
  static const String writeReviewCommentHint = 'Chia sẻ cảm nhận của bạn về sản phẩm...';
  ...
  static const String reviewListParseError = 'Phản hồi danh sách đánh giá không hợp lệ';
  static const String reviewParseError = 'Phản hồi đánh giá không hợp lệ';
  static const String writeReviewParseError = 'Phản hồi gửi đánh giá không hợp lệ';
  ...
  static const String addressEmptySubtitle = 'Thêm địa chỉ để thuận tiện khi đặt hàng.';
  ...
  static const String addressDeleteConfirm = 'Bạn có chắc muốn xóa địa chỉ này?';
  ...
  static const String addressSetDefaultSuccess = 'Đã đặt địa chỉ mặc định thành công!';
  static const String addressLoadError = 'Không thể tải địa chỉ. Vui lòng thử lại sau.';
  ...
  static const String addressPhoneInvalid = 'Số điện thoại không hợp lệ (VD: 0912345678)';
  ...
  static const String addressProvincePickerRequired = 'Vui lòng chọn tỉnh/thành phố';
  static const String addressDistrictPickerRequired = 'Vui lòng chọn quận/huyện';
  ...
  static const String addressDefaultOrderHint = 'Dùng địa chỉ này mặc định khi đặt hàng';
  ...
  static const String shopLoadError = 'Không thể tải thông tin cửa hàng. Vui lòng thử lại sau.';
  ...
  static const String shopMapUnavailable = 'Chưa có vị trí bản đồ cho cửa hàng này.';
  static const String adminShopConfigTitle = 'Cấu hình cửa hàng';
  static const String shopSaveChanges = 'Lưu thay đổi';
  static const String shopUpdateSuccess = 'Đã cập nhật thông tin cửa hàng thành công!';
  static const String shopUpdateError = 'Cập nhật cửa hàng thất bại. Vui lòng thử lại.';
  ...
  static const String shopFieldOpeningHoursHint = 'Ví dụ: 8:00 – 21:00 (T2 – CN)';
  static const String shopFieldDescription = 'Mô tả cửa hàng';
  static const String shopFieldDescriptionHint = 'Nhập mô tả ngắn về cửa hàng...';
  ...
  static const String shopValidationNameRequired = 'Tên cửa hàng không được để trống';
  static const String shopValidationRatingInvalid = 'Đánh giá phải là số thực (ví dụ: 4.8)';
  static const String shopValidationRatingRange = 'Đánh giá phải nằm trong khoảng 0.0 – 5.0';
  static const String shopValidationRatingCountInvalid = 'Số lượt đánh giá phải là số nguyên không âm';
  ...
  static const String adminProductBulkSizeGroupRequired = 'Vui lòng chọn nhóm size';
  ...
  static const String adminProductBulkDefaultsStep = '4. THÔNG SỐ BIẾN THỂ MẶC ĐỊNH';
  ...
  static String adminProductBulkConfirmSaveCount(int count) => 'Xác nhận & Lưu ($count)';
  static const String adminProductVariantBasicInfoRequired = 'Hoàn tất thông tin cơ bản ở Bước 1 trước khi thêm biến thể.';
  static const String adminProductVariantEmptyTitle = 'Chưa có biến thể nào';
  static const String adminProductVariantEmptyHint = 'Nhấn "Thêm biến thể" để thêm mới';
  static const String adminProductVariantAddTitle = 'Thêm biến thể';
  static const String adminProductVariantColorLabel = 'Màu sắc *';
  static const String adminProductVariantColorRequired = 'Vui lòng chọn màu sắc';
  ...
  static String adminProductVariantSubtitle({required String size, required String colorName, required String price, String? salePrice}) => salePrice == null ? '$size · $colorName · $price' : '$size · $colorName · $price (Sale: $salePrice)';
  ...
  static String adminProductDetailLabel(String label, String value) => '$label: $value';
  static String adminProductDetailVariantTitle(String size, String colorName) => '$size — $colorName';
  static String adminProductDetailVariantSubtitle({required String sku, required int stock, required String price, String? salePrice}) { final base = 'SKU: $sku • Tồn: $stock • $price'; return salePrice == null ? base : '$base (Sale: $salePrice)'; }
  ...
  static String adminProductDeleteMessage(String name) => 'Xóa sản phẩm "$name"?';
  ...
  static const String adminProductDropdownLoadError = 'Không thể tải danh sách.';
  static const String adminProductAbandonTitle = 'Rời khỏi form?';
  static const String adminProductAbandonMessage = 'Sản phẩm đã được tạo nhưng chưa hoàn tất.\nXóa sản phẩm này và thoát?';
  ...
  static const String adminProductManualDeleteWarning = 'Không thể xóa sản phẩm. Vui lòng xóa thủ công từ danh sách.';
  ...
  static const String adminProductImagesBasicInfoRequired = 'Hoàn tất thông tin cơ bản ở Bước 1 trước khi thêm ảnh.';
  static String adminProductImagesTitle(int count, int max) => 'Hình ảnh sản phẩm ($count/$max)';
  static String adminProductImagesUploadLimit(int remaining, int max) => 'Chỉ tải lên $remaining ảnh còn lại (giới hạn $max ảnh)';
  ...
  static const String adminBrandLoadFallback = 'Đã xảy ra lỗi khi tải thương hiệu.';
  static const String adminBrandDeleteTitle = 'Xóa thương hiệu?';
  static String adminBrandDeleteMessage(String name) => 'Bạn có chắc chắn muốn xóa thương hiệu "$name"? Hành động này không thể hoàn tác.';
  ...
  static const String adminBrandNameInvalid = 'Tên thương hiệu phải từ 2 đến 100 ký tự!';
  ...
  static const String adminBrandDescriptionHint = 'Nhập mô tả về thương hiệu...';
  ...
  static const String adminCategoryEmptyMessage = 'Nhấn "Thêm" để tạo danh mục đầu tiên.';
  ...
  static String adminCategoryDeleteMessage(String name) => 'Bạn có chắc muốn xóa "$name"?';
  ...
  static const String adminCouponEmptyMessage = 'Nhấn "Thêm" để tạo mã đầu tiên.';
  ...
  static String adminCouponDeleteMessage(String code) => 'Bạn có chắc muốn xóa mã "$code"?';
  static const String adminCouponCreated = 'Đã tạo mã giảm giá';
  static const String adminCouponUpdated = 'Đã cập nhật mã giảm giá';
  static const String adminCouponEndDateAfterStart = 'Ngày kết thúc phải sau ngày bắt đầu';
  ...
  static String adminCouponFilteredCount(int filtered, int total) => '$filtered/$total mã';
  static String adminCouponNoMatches(String query) => 'Không có mã nào khớp "$query".';
  static String adminCouponUsedWithLimit(int used, int limit) => 'Đã dùng $used/$limit';
  ...
  static const String adminProductBasicNameRequired = 'Vui lòng nhập tên sản phẩm';
  static const String adminProductBasicDescriptionLabel = 'Mô tả';
  static const String adminProductBasicCategoryLabel = 'Danh mục *';
  static const String adminProductBasicCategoryRequired = 'Vui lòng chọn danh mục';
  static const String adminProductBasicBrandLabel = 'Thương hiệu *';
  static const String adminProductBasicBrandRequired = 'Vui lòng chọn thương hiệu';
  ...
  static const String adminProductBasicGenderRequired = 'Vui lòng chọn giới tính';
  ...
  static const String adminProductBasicFeaturedSubtitle = 'Hiển thị trên trang chủ';
  ...
  static const String adminReviewsEmptySubtitle = 'Đánh giá của khách hàng sẽ hiển thị ở đây.';
  ...
  static const String adminReviewReplyRequired = 'Vui lòng nhập nội dung phản hồi';
  static const String adminDashboardLoadError = 'Đã xảy ra lỗi khi tải dữ liệu Admin.';
  ...
  static const String adminOrderStatusUpdated = 'Đã cập nhật trạng thái đơn hàng!';
  ...
  static String adminOrderStatusChangeConfirm(String status) => 'Đổi trạng thái sang "$status"?';
  static const String adminManagementTitle = 'Quản lý';
  static const String adminManagementSubtitle = 'Truy cập nhanh các mục quản trị';
  ...
  static String adminTrafficDay(String day, int value) => 'Lưu lượng $day: $value%';
  static const String adminRevenueLoading = 'Đang tải…';
  static const String adminRevenueEmptyRange = 'Không có doanh thu trong khoảng đã chọn';
  static const String adminRevenueErrorWithPrevious = 'Dữ liệu cũ đang được giữ lại';
  static const String adminRevenueErrorNoData = 'Không thể tải dữ liệu doanh thu';
  ...
  static String adminRevenueRangeText(String start, String end) => '$start – $end';
  static String adminRevenueDeliveredAndAverage(int count, String average) => 'Đơn đã giao: $count · Trung bình: $average';
  ...
  static String adminNotificationOrderText(dynamic orderId, String createdAt) => 'Đơn hàng #$orderId • $createdAt';
  ...
  static const String adminLocationNoSelection = 'Tìm địa chỉ hoặc chạm bản đồ để chọn vị trí cửa hàng';
  ...
  static const String categoryStatusActiveSubtitle = 'Hiển thị danh mục cho khách hàng';
  static const String categoryCustomizableTitle = 'Cho phép tùy chỉnh';
  static const String categoryCustomizableSubtitle = 'Sản phẩm trong danh mục có thể tùy biến';
  static const String adminDashboardAppName = 'Sport Pro';
  static String adminDashboardDate(String date) => date;
  static String adminDashboardChartTooltip(String day, int value) => 'Lưu lượng $day: $value%';
  ...
  static const String adminProductLoadListError = 'Không thể tải danh sách. Vui lòng thử lại.';
  static const String adminProductFillRequired = 'Vui lòng điền đầy đủ thông tin bắt buộc';
  static String adminProductDeleteError(String msg) => 'Không thể xóa sản phẩm: $msg';
  ...
  static String adminSizeGroupDeleteBody(String name) => 'Bạn có chắc muốn xóa nhóm kích thước "$name"?';
  ...
  static String adminColorDeleteProductBody(String name) => 'Bạn có chắc muốn xóa màu "$name" khỏi sản phẩm?';
  static const String adminColorDeletePrintingTitle = 'Xóa màu in ấn?';
  static String adminColorDeletePrintingBody(String name) => 'Bạn có chắc muốn xóa màu in ấn "$name"?';
  ...
  static const String adminColorPrintingNameHint = 'Nhập tên màu in (ví dụ: Gold Foil)';
  static const String adminColorHexLabel = 'MÃ HEX (HEX CODE)';
  static const String adminColorPrintingHexHint = 'Nhập mã Hex (ví dụ: #D4AF37)';
  ...
  static const String adminColorPrintingNameRequired = 'Vui lòng nhập tên màu in!';
  ...
  static const String adminColorProductFormCreateTitle = 'Thêm màu sản phẩm mới';
  static const String adminColorProductNameLabel = 'TÊN MÀU SẮC';
  static const String adminColorProductNameHint = 'Nhập tên màu (ví dụ: Aero Blue)';
  ...
  static const String adminColorHexInvalidFull = 'Mã HEX không hợp lệ! Vui lòng bắt đầu với # và có 3 hoặc 6 ký tự số/chữ.';
  ...
  static const String adminColorPrintingCreated = 'Đã thêm màu in ấn thành công!';
  static const String adminColorPrintingUpdated = 'Đã cập nhật màu in ấn thành công!';
  static const String adminColorPrintingDeleted = 'Đã xóa màu in ấn thành công!';
  static const String adminColorPrintingStatusUpdated = 'Đã cập nhật trạng thái màu in!';
  static const String adminColorProductCreated = 'Đã thêm màu sản phẩm thành công!';
  static const String adminColorProductUpdated = 'Đã cập nhật màu sản phẩm thành công!';
  static const String adminColorProductDeleted = 'Đã xóa màu sản phẩm thành công!';
}
// dart format on

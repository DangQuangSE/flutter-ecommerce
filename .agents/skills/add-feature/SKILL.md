...
- Use this when creating a new e-commerce feature from scratch (e.g. wishlist, review, notification, etc.)
- Use this to ensure all required directories and basic architecture components (data, domain, presentation) are initialized correctly from the start.
